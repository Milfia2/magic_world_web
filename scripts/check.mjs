...
for (const file of ['js/app.js', 'js/data.js', 'js/dialogue.js', 'js/state.js', 'js/scene-layout.js', 'js/character-spawns.js', 'js/schedule.js', 'js/flight.js', 'js/agent-tools.js', 'scripts/build.mjs', 'scripts/serve.mjs']) {
